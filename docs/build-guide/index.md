...
description: Three-phase build guide for your PiTrac DIY golf launch monitor covering hardware assembly, Raspberry Pi setup, and software install with companion videos.
---
...
We're developing companion videos to the written documentation to better visually show how to build your PiTrac. Here's what we have so far (no link means the video is still in the works):

| Part | Topic | Link |
|------|-------|------|
| 1 | Introduction to PiTrac | *Coming soon* |
| 2A | 3D Printing the PiTrac Tower | *Coming soon* |
| 2B | 3D Printing the BaseBox | [Watch](https://youtu.be/DwA4mXsMMAY){ target="_blank" } |
| 3B | Tower Build | [Watch](https://youtu.be/8COCvxQgKR8){ target="_blank" } |
| 4A | Component Installation | [Watch](https://youtu.be/93e-ukvGhJ0){ target="_blank" } |
| 4B | PiTrac Software Setup | [Watch](https://youtu.be/M0pMmwSKbK4){ target="_blank" } |
| 4C | Optional Software | [Watch](https://youtu.be/0mW1fRwRDdU){ target="_blank" } |
...
**[Parts List](../hardware/parts-list.md)**{ .md-button }
...
**[PCB Assembly Guide](../hardware/pcb-assembly.md)**{ .md-button }
...
**[3D Printing Guide](../hardware/v3-enclosure/3d-printing.md)**{ .md-button }
...
**[Pi Setup Guide](../software/pi-setup/index.md)**{ .md-button }
...
**[Installation Guide](../software/installation/index.md)**{ .md-button }
...
Ready to start? Head to the [Parts List](../hardware/parts-list.md) to begin your build!
