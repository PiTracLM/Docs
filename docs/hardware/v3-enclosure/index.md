...
![PiTrac V3 Enclosure](../../assets/images/V3_Enclosure/PiTrac_V3-Enclosure.png)
...
| Camera | Position | X (m) | Y (m) | Z (m) | Coordinate Array |
|--------|----------|-------|-------|-------|------------------|
| Camera1 | Tee - far back / long rig | -0.522 | -0.241 | 0.483 | `["-0.522", "-0.241", "0.483"]` |
| Camera1 | Tee - near / short rig | -0.117 | -0.241 | 0.483 | `["-0.117", "-0.241", "0.483"]` |
| Camera2 | Flight | 0 | 0.109 | 0.473 | `["0", "0.109", "0.473"]` |

Assumption: eyeball screen to front plane has a Z-distance of 30 mm (acc. to the assembly readme and drawings)
...
| 4 | Safety | IP40 IEC 60529 protection (ideally) | no fingers or tools should access critical areas | Rather IP20; all mains cables covered; no ventilation holes >5 mm near PSU; mains voltage not accessible | done |
...
| 9 | Compatibility | Max footprint 175 x 175 mm | for small printers (e.g. Prusa Mini) | Largest part: 160 x 148 x 87.5 mm; room for brim or skirts | done |
|10 | Compatibility | 2x Pi 4 with heatsink | - | 100 x 265 x 32 mm electronics space; USB cables may be limiting | done |
|11 | Compatibility | 2x Pi 5 with heatsink | - | 100 x 265 x 32 mm electronics space; USB cables may be limiting | done |
...
|22 | Optics | Adjustable cameras (pan/tilt) | - | Pan +/-30 deg, tilt +/-20 deg; suitable for long calibration rig; field of view likely obstructed for wideangle + full pan setup | done |
|23 | Optics | Adjustable LED (pan/tilt) | - | Pan/tilt up to 30 deg; mostly unnecessary | done |
...
|37 | Structure | Shank shield thickness | 3/16 in or 1/4 in | 7 mm slot; 1/4 in fits; 3/16 in may need spacer | done |
