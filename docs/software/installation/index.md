...
!!! note "Prerequisites Required"
    Complete [Raspberry Pi Setup](../pi-setup/index.md) before installing PiTrac. Your Pi must have the OS installed, be updated, and have network access.
...
!!! warning "Critical"
    You must have completed the [Raspberry Pi Setup](../pi-setup/index.md) before proceeding. This includes OS installation, system updates, and network configuration.
...
**[Managing PiTrac Guide](managing.md)**
...
3. **Calibrate** (after first use)
    ...
    - See [Cameras](../../hardware/cameras/index.md) for details
...
1. **[First Use Guide](first-use.md)** -- Access web interface and make first shot
...
- **[Express Path](../../build-guide/express-path.md)** -- Streamlined setup for experienced users

**Reference:**

- **[Managing PiTrac](managing.md)** -- Commands, file locations, updates
