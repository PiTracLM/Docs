...
!!! tip
    You can also set the E6 host address in Configuration > Simulators > E6 section.
...
!!! tip
    You can also set the GSPro host address in Configuration > Simulators > GSPro section.
...
!!! info "Recommended Start Order"
    It usually works best to:

    1. Start your simulator software first
    2. Get it into practice/play mode
    3. Then start PiTrac LM from the web dashboard (click Start button)
    4. Hit balls
...
Still stuck? Head to the [Discord](https://discord.gg/j9YWCMFVHN) with:
