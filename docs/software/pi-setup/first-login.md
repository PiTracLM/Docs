...
- `VERSION_CODENAME` should be `trixie` (Debian 13)
...
- **[Install PiTrac Software](../installation/index.md)** - Install the launch monitor software

**Optional Advanced Configuration:**

- **[Advanced Setup](advanced.md)** - NVMe boot, NAS mounting, SSH keys
