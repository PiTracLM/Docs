...
!!! warning "CRITICAL - OS Version Requirements"
    PiTrac requires **Raspberry Pi OS 64-bit**

    - **Supported version:** Debian 13 (Trixie)
...
!!! note "Important"
    Must be 64-bit version. Do not use 32-bit versions.
...
!!! warning "Data Loss"
    Triple-check this is your SD card and NOT your computer's hard drive! Everything on this storage will be erased.
...
Continue to: **[First Login & Updates](first-login.md)**

Or return to: **[Pi Setup Overview](index.md)**
