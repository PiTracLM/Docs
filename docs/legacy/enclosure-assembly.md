---
title: V1 Enclosure Assembly
description: Complete step-by-step guide for assembling the legacy PiTrac V1 enclosure, including 3D printed parts, camera mounting, and electronics installation.
---
...
!!! note "Legacy guide"
    A new assembly guide that is directed at the Version 2 enclosure is in the works. Please go to the Discord Server to see how other folks have been assembling their Version 2 system. This assembly guide is still relevant at a high level, but was directed to the older (and clunkier) Version 1 enclosure. Please also note there are some differences (and improvements) when using cameras such as the InnoMaker IMX296. In particular, most of the difficult modifications required for the "official" Raspberry Pi cameras are no longer necessary.

!!! note
    **Important:** This document refers to the calibration steps for the camera sub-system, which should be consulted prior to building the enclosure. Calibration is most easily done *as the LM is being assembled* because it allows easier access to cameras and camera mounts before the LM is completed. See [Camera Calibration](../hardware/cameras/index.md) for details. However, for the Version 2 enclosure, the cameras are much more accessible, and you can probably do the calibration after everything is built.
...
1. See the [Parts List](../hardware/parts-list.md) for complete component list
...
**Important:** Calibrate Camera 2 now while easily accessible. See [Camera Calibration Guide](../hardware/cameras/index.md).
...
Before installing the ceiling, calibrate Camera 1 using the [Camera Calibration Guide](../hardware/cameras/index.md).
...
Once assembly is complete, proceed to the [Software](../software/index.md) documentation for software installation and configuration.
