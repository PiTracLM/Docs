---
title: 3D Printing (V1 / V2)
description: 3D printing guide for the legacy PiTrac V1 and V2 enclosure components, including STL file downloads, printer requirements, material recommendations, and printing tips.
---

# 3D Printing (V1 / V2 Enclosures)
...
!!! note "Legacy enclosures"
    This page covers the older V1 and V2 enclosures. For current builds, see the [V3 Enclosure 3D Printing](../hardware/v3-enclosure/3d-printing.md) guide.
...
For detailed printing and assembly instructions, see the [V1 Enclosure Assembly Guide](enclosure-assembly.md).
